...
namespace PS5000AStreamingConsole
{
	class Imports
	{
        ...
        //pd. 1)
        public const uint PS5000A_SHOT_SWEEP_TRIGGER_CONTINUOUS_RUN = (uint)0xFFFFFFFF;
        ...
        //pd. 2)
        public enum enPS5000AWaveType : uint
        {
            PS5000A_SINE,
            PS5000A_SQUARE,
            PS5000A_TRIANGLE,
        ...
        public enum enPS5000ASweepType : uint
        {
            PS5000A_UP,
            PS5000A_DOWN,
            PS5000A_UPDOWN,
        ...
        public enum enPS5000AExtraOperations : uint
        {
            PS5000A_ES_OFF,
            PS5000A_WHITENOISE,
        ...
        public enum enPS5000ASigGenTrigType
        {
        ...
        public enum enPS5000ASigGenTrigSource
        {
            PS5000A_SIGGEN_NONE,
        ...
        //pd.2+ add this to region driver imports:
        [DllImport(_DRIVER_FILENAME, EntryPoint = "ps5000aSetSigGenBuiltIn")]
        public static extern uint ps5000aSetSigGenBuiltIn(
                                                        short handle,
                                                        long offsetVoltage,
                                                        ulong pkToPk,
                                                        enPS5000AWaveType waveType,
                                                        float startFrequency,
                                                        float stopFrequency,
                                                        float increment,
                                                        float dwellTime,
                                                        enPS5000ASweepType sweepType,
                                                        enPS5000AExtraOperations operation,
                                                        ulong shots,
                                                        ulong sweeps,
                                                        enPS5000ASigGenTrigType triggerType,
                                                        enPS5000ASigGenTrigSource triggerSource,
